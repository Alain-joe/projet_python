...
CORRECTION : Remplacement de ft.Wrap (inexistant) par ft.Row(wrap=True).
"""
...
def build_exhumations_list_view(page: ft.Page, auth: AuthState) -> ft.View:
    ...
    def build_exhumation_card(ex: dict) -> ft.Control:
        ...
        is_admin_or_sec = auth.role in [Role.ADMIN, Role.SECRETARIAT]
        ...
        return ft.Container(
            content=ft.Column([
                ...
                # ✅ CORRECTION : ft.Row(wrap=True) au lieu de ft.Wrap
    ...
    return ft.View(
        ...
        controls=[
            ...
            ft.Text("Suivi des demandes, validation et libération des caveaux.", size=14, color=Colors.NEUTRAL),
