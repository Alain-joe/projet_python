...
CORRECTION : Correction de la syntaxe Route() pour /graves/generate-grid
"""
...
def build_routes(auth: AuthState) -> list[Route]:
    ...
    return [
        ...
        # ✅ CORRECTION ICI : Route au lieu de Router, et ajout de la virgule
